              ...
              {content.experience.map((exp, index) => (
                ...
                >
                  ...
                  <motion.div 
                    ...
                    className="absolute -left-[41px] top-0 w-5 h-5 bg-dark border-4 border-primary rounded-full z-10"
                  />
                  
                  <motion.div 
                    whileHover={{ scale: 1.02, x: 5, backgroundColor: "rgba(255, 255, 255, 0.05)" }}
                    className="glass-card p-6 rounded-xl border border-white/5 hover:border-primary/30 transition-colors"
                  >
                    ...
                    {exp.details && (
                      <ul className="list-disc list-outside ml-4 space-y-1 text-gray-400 text-xs md:text-sm marker:text-primary">
              ...
              {content.education.map((edu, index) => (
                ...
                >
                  ...
                  <motion.div 
                     ...
                     whileInView={{ scale: [1, 1.2, 1] }}
                     transition={{ duration: 1, delay: index * 0.1 + 0.5 }}
                     className="absolute -left-[41px] top-0 w-5 h-5 bg-dark border-4 border-secondary rounded-full z-10"
                  />
                  
                  <motion.div 
                    whileHover={{ scale: 1.02, x: 5, backgroundColor: "rgba(255, 255, 255, 0.05)" }}
                    className="glass-card p-6 rounded-xl border border-white/5 hover:border-secondary/30 transition-colors"
                  >
