      ...
      <div className="container mx-auto px-6 z-10 text-center">
        ...
        >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-flex h-12 animate-shimmer items-center justify-center rounded-full border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#6366f1,55%,#000103)] bg-[length:200%_100%] px-8 font-medium text-white transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-slate-50 cursor-pointer shadow-lg"
          >
            Ver Projetos
          </motion.a>
          ...
          <MagneticButton
            ...
            className="px-8 py-3.5 bg-transparent border border-white/20 text-white font-bold rounded-full cursor-pointer hover:bg-white/5 transition-colors"
          >
            Entrar em Contato
          </MagneticButton>
        </motion.div>
